...
const Index = () => {
  ...
  // Controla o scroll do corpo da página para evitar rolagem enquanto o overlay está ativo
  useEffect(() => {
    if (!isRevealed) {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-amber-100 overflow-x-hidden">
      {/* Overlay de Entrada */}
      {!isRevealed && <RevealOverlay onComplete={() => setIsRevealed(true)} />}

      {/* Conteúdo Principal - Só renderiza o vídeo após o reveal para evitar duplicidade/autoplay bloqueado */}
      <main 
